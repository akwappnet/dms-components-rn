...
const VersionUtils_1 = __importDefault(require("../utils/VersionUtils"));
class NavigatorService {
    static callProg(routineName, jsonObject) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const apikey = yield Dms_1.Dms.GetAPIKeyBasic();
                const serverAddress = (_a = (yield Dms_1.Dms.getServerAddress())) !== null && _a !== void 0 ? _a : "";
                const sessionID = (_b = (yield Dms_1.Dms.getData("sessionID"))) !== null && _b !== void 0 ? _b : "";
                const userID = (_c = (yield Dms_1.Dms.getData("userID"))) !== null && _c !== void 0 ? _c : "";
                jsonObject.versionNumber = VersionUtils_1.default.getVersionNumber();
                ...
                if (response.ok) {
                    ...
                    yield react_native_1.Alert.alert("Error 2", "Conection Error", [{ text: "Ok" }], {
                        cancelable: true,
                    });
                }
                return "ok";
    ...
    static getNavigatorReportold(reportName, paramsList) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let apikey = yield Dms_1.Dms.GetAPIKey();
    ...
    static WriteFileBase64(filePath, base64) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield fetch("https://services-pool.dmservices.co.uk/DmsNavigator.NavigatorWebService.svc/WriteFileBase64", {
                method: "POST",
                body: data,
                headers: {
                    "Content-Type": "text/text",
    ...
    static ReadFile(filePath) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            const apikey = yield Dms_1.Dms.GetAPIKeyBasic();
            const sessionID = (_a = (yield Dms_1.Dms.getData("sessionID"))) !== null && _a !== void 0 ? _a : "";
